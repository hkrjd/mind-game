...
(async () => {
  ...
  ok(await page.locator('#home-grid .game-card').count() === 25, 'home shows 25 game cards');
  ok(await page.locator('#home-grid .home-cat').count() === 4, 'home shows 4 category headings');
