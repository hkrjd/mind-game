...
(async () => {
  ...
  try {
    ...
    ok(await page.locator('#home-grid .game-card').count() === 27, 'app boots over http with 27 cards');
    ...
    ok(await page.locator('#home-grid .game-card').count() === 27, 'OFFLINE reload still boots the full app');
